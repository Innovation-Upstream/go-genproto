...
// 	protoc        v3.18.1
// source: type/meta/reference/v1beta3/reference.proto
...
func (ReferenceType) Descriptor() protoreflect.EnumDescriptor {
	return file_type_meta_reference_v1beta3_reference_proto_enumTypes[0].Descriptor()
}

func (ReferenceType) Type() protoreflect.EnumType {
	return &file_type_meta_reference_v1beta3_reference_proto_enumTypes[0]
}
...
func (ReferenceType) EnumDescriptor() ([]byte, []int) {
	return file_type_meta_reference_v1beta3_reference_proto_rawDescGZIP(), []int{0}
}
...
func (ReferenceMatchType) Descriptor() protoreflect.EnumDescriptor {
	return file_type_meta_reference_v1beta3_reference_proto_enumTypes[1].Descriptor()
}

func (ReferenceMatchType) Type() protoreflect.EnumType {
	return &file_type_meta_reference_v1beta3_reference_proto_enumTypes[1]
}
...
func (ReferenceMatchType) EnumDescriptor() ([]byte, []int) {
	return file_type_meta_reference_v1beta3_reference_proto_rawDescGZIP(), []int{1}
}
...
type SingleReference struct {
	...
	Type ReferenceType `protobuf:"varint,1,opt,name=type,proto3,enum=innovationupstream.type.meta.reference.v1beta3.ReferenceType" json:"type,omitempty"`
...
func (x *SingleReference) Reset() {
	*x = SingleReference{}
	if protoimpl.UnsafeEnabled {
		mi := &file_type_meta_reference_v1beta3_reference_proto_msgTypes[0]
...
func (x *LabelledSingleReference) Reset() {
	*x = LabelledSingleReference{}
	if protoimpl.UnsafeEnabled {
		mi := &file_type_meta_reference_v1beta3_reference_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
type ReferenceMatch struct {
	...
	MatchType ReferenceMatchType `protobuf:"varint,1,opt,name=match_type,json=matchType,proto3,enum=innovationupstream.type.meta.reference.v1beta3.ReferenceMatchType" json:"match_type,omitempty"`
	Ids       []string           `protobuf:"bytes,2,rep,name=ids,proto3" json:"ids,omitempty"`
	Type      ReferenceType      `protobuf:"varint,3,opt,name=type,proto3,enum=innovationupstream.type.meta.reference.v1beta3.ReferenceType" json:"type,omitempty"`
}

func (x *ReferenceMatch) Reset() {
	*x = ReferenceMatch{}
	if protoimpl.UnsafeEnabled {
		mi := &file_type_meta_reference_v1beta3_reference_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ReferenceMatch) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReferenceMatch) ProtoMessage() {}

func (x *ReferenceMatch) ProtoReflect() protoreflect.Message {
	mi := &file_type_meta_reference_v1beta3_reference_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReferenceMatch.ProtoReflect.Descriptor instead.
func (*ReferenceMatch) Descriptor() ([]byte, []int) {
	return file_type_meta_reference_v1beta3_reference_proto_rawDescGZIP(), []int{2}
}

func (x *ReferenceMatch) GetMatchType() ReferenceMatchType {
	if x != nil {
		return x.MatchType
	}
...
func (x *ReferenceMatch) GetIds() []string {
	if x != nil {
		return x.Ids
	}
	return nil
...
func (x *ReferenceMatch) GetType() ReferenceType {
	if x != nil {
		return x.Type
	}
	return ReferenceType_ReferenceType_UNSPECIFIED
...
var File_type_meta_reference_v1beta3_reference_proto protoreflect.FileDescriptor

var file_type_meta_reference_v1beta3_reference_proto_rawDesc = []byte{
	0x0a, 0x2b, 0x74, 0x79, 0x70, 0x65, 0x2f, 0x6d, 0x65, 0x74, 0x61, 0x2f, 0x72, 0x65, 0x66, 0x65,
	0x72, 0x65, 0x6e, 0x63, 0x65, 0x2f, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x33, 0x2f, 0x72, 0x65,
	...
	0x72, 0x65, 0x6e, 0x63, 0x65, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x33, 0x22, 0x74, 0x0a,
	...
	0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x33, 0x2e,
	...
	0x65, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x33, 0x2e, 0x53, 0x69, 0x6e, 0x67, 0x6c, 0x65,
	...
	0x63, 0x65, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x12, 0x61, 0x0a, 0x0a, 0x6d, 0x61, 0x74, 0x63, 0x68,
	...
	0x65, 0x6e, 0x63, 0x65, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x33, 0x2e, 0x52, 0x65, 0x66,
	...
	0x6e, 0x63, 0x65, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x33, 0x2e, 0x52, 0x65, 0x66, 0x65,
	...
	0x65, 0x74, 0x61, 0x33, 0x3b, 0x72, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x62, 0x06,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_type_meta_reference_v1beta3_reference_proto_rawDescOnce sync.Once
	file_type_meta_reference_v1beta3_reference_proto_rawDescData = file_type_meta_reference_v1beta3_reference_proto_rawDesc
)

func file_type_meta_reference_v1beta3_reference_proto_rawDescGZIP() []byte {
	file_type_meta_reference_v1beta3_reference_proto_rawDescOnce.Do(func() {
		file_type_meta_reference_v1beta3_reference_proto_rawDescData = protoimpl.X.CompressGZIP(file_type_meta_reference_v1beta3_reference_proto_rawDescData)
	})
	return file_type_meta_reference_v1beta3_reference_proto_rawDescData
}

var file_type_meta_reference_v1beta3_reference_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_type_meta_reference_v1beta3_reference_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_type_meta_reference_v1beta3_reference_proto_goTypes = []interface{}{
	(ReferenceType)(0),              // 0: innovationupstream.type.meta.reference.v1beta3.ReferenceType
	(ReferenceMatchType)(0),         // 1: innovationupstream.type.meta.reference.v1beta3.ReferenceMatchType
	(*SingleReference)(nil),         // 2: innovationupstream.type.meta.reference.v1beta3.SingleReference
	(*LabelledSingleReference)(nil), // 3: innovationupstream.type.meta.reference.v1beta3.LabelledSingleReference
	(*ReferenceMatch)(nil),          // 4: innovationupstream.type.meta.reference.v1beta3.ReferenceMatch
}
var file_type_meta_reference_v1beta3_reference_proto_depIdxs = []int32{
	0, // 0: innovationupstream.type.meta.reference.v1beta3.SingleReference.type:type_name -> innovationupstream.type.meta.reference.v1beta3.ReferenceType
	2, // 1: innovationupstream.type.meta.reference.v1beta3.LabelledSingleReference.reference:type_name -> innovationupstream.type.meta.reference.v1beta3.SingleReference
	1, // 2: innovationupstream.type.meta.reference.v1beta3.ReferenceMatch.match_type:type_name -> innovationupstream.type.meta.reference.v1beta3.ReferenceMatchType
	0, // 3: innovationupstream.type.meta.reference.v1beta3.ReferenceMatch.type:type_name -> innovationupstream.type.meta.reference.v1beta3.ReferenceType
...
func init() { file_type_meta_reference_v1beta3_reference_proto_init() }
func file_type_meta_reference_v1beta3_reference_proto_init() {
	if File_type_meta_reference_v1beta3_reference_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_type_meta_reference_v1beta3_reference_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_type_meta_reference_v1beta3_reference_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_type_meta_reference_v1beta3_reference_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReferenceMatch); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_type_meta_reference_v1beta3_reference_proto_rawDesc,
			NumEnums:      2,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_type_meta_reference_v1beta3_reference_proto_goTypes,
		DependencyIndexes: file_type_meta_reference_v1beta3_reference_proto_depIdxs,
		EnumInfos:         file_type_meta_reference_v1beta3_reference_proto_enumTypes,
		MessageInfos:      file_type_meta_reference_v1beta3_reference_proto_msgTypes,
	}.Build()
	File_type_meta_reference_v1beta3_reference_proto = out.File
	file_type_meta_reference_v1beta3_reference_proto_rawDesc = nil
	file_type_meta_reference_v1beta3_reference_proto_goTypes = nil
	file_type_meta_reference_v1beta3_reference_proto_depIdxs = nil
}
